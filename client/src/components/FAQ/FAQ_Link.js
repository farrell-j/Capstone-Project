...
const FAQ_Link = () => {
  ...
  useEffect(() => {
    // Get image 
    const rocketImg = document.getElementById("rocket_top_img");

    // Add event listener_img
    rocketImg.addEventListener("click", scrollToTop);

    // Clean up listener on unmount
    return () => {
        rocketImg.removeEventListener("click", scrollToTop);
    };
  }, []);
            ...
            <div>
              <h2>How do I... </h2>
                    <div id='faq_links'>
                            ...
                            <ol>
                            <li><a href="#q1">How do I read a two-line elset?</a></li>
                            <li><a href="#q2">How do I convert two-line elements to some other format?</a></li>
                            <li><a href="#q3">What is the accuracy of predictions using the two-line element sets?</a></li>
                            <li><a href="#q4">How often are element sets generated?</a></li>
                            <li><a href="#q5">What is the reference frame of the resulting coordinates?</a></li>
                            <li><a href="#q6">Are there two-line element sets for the moon and/or sun?</a></li>
                            <li><a href="#q7">How do new satellite elements get added to the CelesTrak WWW? Can I trust it?</a></li>
                            <li><a href="#q8">How do I find source code for the SGP4/SDP4 orbital models?</a></li>
                            <li><a href="#q9">Where do I find a list of satellite frequencies?</a></li>
                            <li><a href="#q10">How do I obtain historical element sets?</a></li>
                            </ol>

                            <h3 id="q1">1. How do you read a two-line elset?</h3>
                            
                            {/* <p><strong>1. How do you read a two-line elset?</strong></p> */}
                            <p>
                            Two Line Format
                            ...
                            <p>
                            Source: <a href="https://www.projectpluto.com/tle_info.htm" target="_blank" rel="noopener noreferrer">https://www.projectpluto.com/tle_info.htm</a>
                            Source: <a href="https://www.amsat.org/keplerian-elements-formats/" target="_blank" rel="noopener noreferrer">https://www.amsat.org/keplerian-elements-formats/</a>
                            </p>

                            </p>

                            <h3 id="q2">2. How does one convert two-line elements to some other format?</h3>

                            {/* <p><strong>2. How does one convert two-line elements to some other format?</strong></p> */}
                            <p>
                            ...
                            <h3 id="q3">3. What is the accuracy of predictions using the two-line element sets?</h3>

                            {/* <p><strong>3. What is the accuracy of predictions using the two-line element sets?</strong></p> */}
                            <p>
                            ...
                            <h3 id="q4">4. How often are element sets generated?</h3>

                            {/* <p><strong>4. How often are element sets generated?</strong></p> */}
                            <p>
                            ...
                            <h3 id="q5">5. What is the reference frame of the resulting coordinates?</h3>

                            {/* <p><strong>5. What is the reference frame of the resulting coordinates?</strong></p> */}
                            <p>
                            ...
                            <h3 id="q6">6. Are there two-line element sets for the moon and/or sun?</h3>

                            {/* <p><strong>6. Are there two-line element sets for the moon and/or sun?</strong></p> */}
                            <p>
                            ...
                            <h3 id="q7">7. How do new satellite elements get added to the CelesTrak WWW? Can I trust it?</h3>
                            
                            <p>
                            {/* <strong>7. How do new satellite elements get added to the CelesTrak WWW? Can I trust it?</strong> */}
                            </p>
                            <p>
                            ...
                            <h3 id="q8">8. How does one find source code for the SGP4/SDP4 orbital models?</h3>

                            <p>
                            {/* <strong>8. How does one find source code for the SGP4/SDP4 orbital models?</strong> */}
                            </p>
                            <p>
                            ...
                            <h3 id="q9">9. Where does one find a list of satellite frequencies?</h3>

                            <p>
                            {/* <strong>9. Where does one find a list of satellite frequencies?</strong> */}
                            </p>
                            <p>
                            ...
                            <h3 id="q10">10. How does one obtain historical element sets?</h3>

                            <p>
                            {/* <strong>10. How does one obtain historical element sets?</strong> */}
                            </p>
                            <p>
                            ...
                            <p>
                            <strong>Correction:</strong> In my last column ("Frequently Asked Questions: Two-Line Element Set Format" Satellite Times Volume 4 Number 3), I suggested that the format for fields 1.10 and 1.11 owed its heritage to the FORTRAN programming language. Instead, as one of our readers pointed out, it originated with the Philco 2000/Model 212 and the TAC assembly language used on the original 496L system. The FORTRAN language just happens to follow the same convention.
                            <a href="https://celestrak.org/columns/v04n05/#FAQ05" target="_blank" rel="noopener noreferrer">Source: https://celestrak.org/columns/v04n05/#FAQ05</a>
                            </p>

                            {/* <p>
                              <img id='rocket_top' src={rocket_ship_log_out_img} alt="Return to Top" />
                            </p> */}
                            ...
                            <div id="top_container">
                              <img
                                ...
                                data-tooltip-content="Return to Top" 
                                id='rocket_top_img' 
