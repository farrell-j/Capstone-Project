...
import banana_peel_img from '../../images/banana_img_2_peel_remove_background.svg';
        ...
        {userLoggedIn ? (
          <>
            ...
            <>
              ...
              <Link to='/presentation' className='navButton hover-effect'>
                <img
                data-tooltip-id="tletip"
                data-tooltip-content="The Future" 
                id='banana_peel' 
                src={banana_peel_img} 
                alt="banana_peel" 
                />
